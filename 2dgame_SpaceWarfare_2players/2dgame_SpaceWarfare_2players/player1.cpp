...
void Player1::update()
{
	...
	if (bullet_exists && bpos_x >= CANVAS_WIDTH-10)
	{
		bpos_x = 0, bpos_y = 0;
		bullet_drawn = false;
		bullet_exists = false;
...
void Player1::draw()
{
	...
	//draw healthbar
	if (hp == 4) { br.texture = std::string(ASSET_PATH) + "4_4healthbar.png"; graphics::drawRect(100, CANVAS_HEIGHT - 20, 100, 100, br); }
	else if (hp == 3) { br.texture = std::string(ASSET_PATH) + "3_4healthbar.png"; graphics::drawRect( 100, CANVAS_HEIGHT - 20, 100, 100, br); }
	else if (hp == 2) { br.texture = std::string(ASSET_PATH) + "2_4healthbar.png"; graphics::drawRect( 100, CANVAS_HEIGHT - 20, 100, 100, br); }
	else if (hp == 1) { br.texture = std::string(ASSET_PATH) + "1_4healthbar.png"; graphics::drawRect( 100, CANVAS_HEIGHT - 20, 100, 100, br); }
	else if (hp == 4) { br.texture = std::string(ASSET_PATH) + "0_4healthbar.png"; graphics::drawRect( 100, CANVAS_HEIGHT - 20, 100, 100, br); }
